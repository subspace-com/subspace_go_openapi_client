...
type V1ListProjectsResponse struct {
	Data *[]V1Project `json:"data,omitempty"`
...
func (o *V1ListProjectsResponse) GetData() []V1Project {
	if o == nil || o.Data == nil {
		var ret []V1Project
		return ret
	}
...
func (o *V1ListProjectsResponse) GetDataOk() (*[]V1Project, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *V1ListProjectsResponse) HasData() bool {
	if o != nil && o.Data != nil {
		return true
	}
...
// SetData gets a reference to the given []V1Project and assigns it to the Data field.
func (o *V1ListProjectsResponse) SetData(v []V1Project) {
	o.Data = &v
}
