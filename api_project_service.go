...
func (r ApiProjectServiceCreateRequest) Execute() (V1Project, *_nethttp.Response, error) {
 ...
 * @return V1Project
 */
func (a *ProjectServiceApiService) ProjectServiceCreateExecute(r ApiProjectServiceCreateRequest) (V1Project, *_nethttp.Response, error) {
	var (
...
func (r ApiProjectServiceGetRequest) Execute() (V1Project, *_nethttp.Response, error) {
	return r.ApiService.ProjectServiceGetExecute(r)
}

/*
 * ProjectServiceGet Method for ProjectServiceGet
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @return ApiProjectServiceGetRequest
 */
func (a *ProjectServiceApiService) ProjectServiceGet(ctx _context.Context, id string) ApiProjectServiceGetRequest {
	return ApiProjectServiceGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return V1Project
 */
func (a *ProjectServiceApiService) ProjectServiceGetExecute(r ApiProjectServiceGetRequest) (V1Project, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/project/{id}"
...
func (r ApiProjectServiceListRequest) Before(before string) ApiProjectServiceListRequest {
	r.before = &before
	return r
}
func (r ApiProjectServiceListRequest) Limit(limit int64) ApiProjectServiceListRequest {
	r.limit = &limit
	return r
}

func (r ApiProjectServiceListRequest) Execute() (V1ListProjectsResponse, *_nethttp.Response, error) {
	return r.ApiService.ProjectServiceListExecute(r)
}

/*
 * ProjectServiceList Method for ProjectServiceList
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 ...
 */
func (a *ProjectServiceApiService) ProjectServiceListExecute(r ApiProjectServiceListRequest) (V1ListProjectsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiProjectServiceUpdateRequest) Execute() (V1Project, *_nethttp.Response, error) {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id id is the project identity
 * @return ApiProjectServiceUpdateRequest
 */
func (a *ProjectServiceApiService) ProjectServiceUpdate(ctx _context.Context, id string) ApiProjectServiceUpdateRequest {
	return ApiProjectServiceUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return V1Project
 */
func (a *ProjectServiceApiService) ProjectServiceUpdateExecute(r ApiProjectServiceUpdateRequest) (V1Project, *_nethttp.Response, error) {
	var (
