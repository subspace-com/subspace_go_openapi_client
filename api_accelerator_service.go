...
func (r ApiAcceleratorServiceListRequest) Execute() (V1ListAcceleratorResponse, *_nethttp.Response, error) {
 ...
 */
func (a *AcceleratorServiceApiService) AcceleratorServiceListExecute(r ApiAcceleratorServiceListRequest) (V1ListAcceleratorResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
