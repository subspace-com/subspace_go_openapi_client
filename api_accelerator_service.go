...
func (r ApiAcceleratorServiceCreateRequest) Execute() (*V1Accelerator, *http.Response, error) {
	return r.ApiService.AcceleratorServiceCreateExecute(r)
}

/*
AcceleratorServiceCreate Method for AcceleratorServiceCreate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiAcceleratorServiceCreateRequest
*/
func (a *AcceleratorServiceApiService) AcceleratorServiceCreate(ctx context.Context) ApiAcceleratorServiceCreateRequest {
	return ApiAcceleratorServiceCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AcceleratorServiceApiService) AcceleratorServiceCreateExecute(r ApiAcceleratorServiceCreateRequest) (*V1Accelerator, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/accelerator"
...
func (r ApiAcceleratorServiceDeleteRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.AcceleratorServiceDeleteExecute(r)
}

/*
AcceleratorServiceDelete Method for AcceleratorServiceDelete

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiAcceleratorServiceDeleteRequest
*/
func (a *AcceleratorServiceApiService) AcceleratorServiceDelete(ctx context.Context, id string) ApiAcceleratorServiceDeleteRequest {
	return ApiAcceleratorServiceDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *AcceleratorServiceApiService) AcceleratorServiceDeleteExecute(r ApiAcceleratorServiceDeleteRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/accelerator/{id}"
...
func (r ApiAcceleratorServiceGetRequest) Execute() (*V1Accelerator, *http.Response, error) {
	return r.ApiService.AcceleratorServiceGetExecute(r)
}

/*
AcceleratorServiceGet Method for AcceleratorServiceGet

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiAcceleratorServiceGetRequest
*/
func (a *AcceleratorServiceApiService) AcceleratorServiceGet(ctx context.Context, id string) ApiAcceleratorServiceGetRequest {
	return ApiAcceleratorServiceGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1Accelerator
func (a *AcceleratorServiceApiService) AcceleratorServiceGetExecute(r ApiAcceleratorServiceGetRequest) (*V1Accelerator, *http.Response, error) {
	var (
...
func (r ApiAcceleratorServiceListRequest) Execute() (*V1ListAcceleratorResponse, *http.Response, error) {
	return r.ApiService.AcceleratorServiceListExecute(r)
}

/*
AcceleratorServiceList Method for AcceleratorServiceList

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiAcceleratorServiceListRequest
*/
func (a *AcceleratorServiceApiService) AcceleratorServiceList(ctx context.Context) ApiAcceleratorServiceListRequest {
	return ApiAcceleratorServiceListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AcceleratorServiceApiService) AcceleratorServiceListExecute(r ApiAcceleratorServiceListRequest) (*V1ListAcceleratorResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V1ListAcceleratorResponse
	)
...
func (r ApiAcceleratorServiceUpdateRequest) Execute() (*V1Accelerator, *http.Response, error) {
	return r.ApiService.AcceleratorServiceUpdateExecute(r)
}

/*
AcceleratorServiceUpdate Method for AcceleratorServiceUpdate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiAcceleratorServiceUpdateRequest
*/
func (a *AcceleratorServiceApiService) AcceleratorServiceUpdate(ctx context.Context, id string) ApiAcceleratorServiceUpdateRequest {
	return ApiAcceleratorServiceUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1Accelerator
func (a *AcceleratorServiceApiService) AcceleratorServiceUpdateExecute(r ApiAcceleratorServiceUpdateRequest) (*V1Accelerator, *http.Response, error) {
	var (
