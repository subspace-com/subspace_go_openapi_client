...
type V1ListSipTeleportResponse struct {
	SipTeleports *[]V1SipTeleportResponse `json:"sip_teleports,omitempty"`
...
func NewV1ListSipTeleportResponse() *V1ListSipTeleportResponse {
	this := V1ListSipTeleportResponse{}
	return &this
}
...
// GetSipTeleports returns the SipTeleports field value if set, zero value otherwise.
func (o *V1ListSipTeleportResponse) GetSipTeleports() []V1SipTeleportResponse {
	if o == nil || o.SipTeleports == nil {
		var ret []V1SipTeleportResponse
		return ret
	}
	return *o.SipTeleports
}

// GetSipTeleportsOk returns a tuple with the SipTeleports field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *V1ListSipTeleportResponse) GetSipTeleportsOk() (*[]V1SipTeleportResponse, bool) {
	if o == nil || o.SipTeleports == nil {
		return nil, false
	}
	return o.SipTeleports, true
}
...
// SetSipTeleports gets a reference to the given []V1SipTeleportResponse and assigns it to the SipTeleports field.
...
func (o V1ListSipTeleportResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.SipTeleports != nil {
		toSerialize["sip_teleports"] = o.SipTeleports
	}
	if o.NextPage != nil {
...
type NullableV1ListSipTeleportResponse struct {
	value *V1ListSipTeleportResponse
	isSet bool
}

func (v NullableV1ListSipTeleportResponse) Get() *V1ListSipTeleportResponse {
	return v.value
}

func (v *NullableV1ListSipTeleportResponse) Set(val *V1ListSipTeleportResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ListSipTeleportResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ListSipTeleportResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ListSipTeleportResponse(val *V1ListSipTeleportResponse) *NullableV1ListSipTeleportResponse {
	return &NullableV1ListSipTeleportResponse{value: val, isSet: true}
}

func (v NullableV1ListSipTeleportResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ListSipTeleportResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
