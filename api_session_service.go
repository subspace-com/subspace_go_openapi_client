...
type ApiSessionServiceList2Request struct {
	ctx _context.Context
	ApiService *SessionServiceApiService
	acceleratorId string
	before *string
...
func (r ApiSessionServiceList2Request) Before(before string) ApiSessionServiceList2Request {
	r.before = &before
	return r
}
func (r ApiSessionServiceList2Request) Limit(limit int64) ApiSessionServiceList2Request {
	r.limit = &limit
	return r
}

func (r ApiSessionServiceList2Request) Execute() (V1ListSessionsResponse, *_nethttp.Response, error) {
	return r.ApiService.SessionServiceList2Execute(r)
}

/*
 * SessionServiceList2 Method for SessionServiceList2
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param acceleratorId
 * @return ApiSessionServiceList2Request
 */
func (a *SessionServiceApiService) SessionServiceList2(ctx _context.Context, acceleratorId string) ApiSessionServiceList2Request {
	return ApiSessionServiceList2Request{
		ApiService: a,
		ctx: ctx,
		acceleratorId: acceleratorId,
 ...
 * @return V1ListSessionsResponse
 */
func (a *SessionServiceApiService) SessionServiceList2Execute(r ApiSessionServiceList2Request) (V1ListSessionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SessionServiceApiService.SessionServiceList2")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
