...
type ApiSipTeleportServiceCreateRequest struct {
	...
	v1CreateSipTeleport *V1CreateSipTeleport
	idempotencyKey *string
}

// Required parameters to create a new SIPTeleport
func (r ApiSipTeleportServiceCreateRequest) V1CreateSipTeleport(v1CreateSipTeleport V1CreateSipTeleport) ApiSipTeleportServiceCreateRequest {
	r.v1CreateSipTeleport = &v1CreateSipTeleport
	return r
}
// Value is the returned etag of a get request.  If a retry sends an Idempotency-Key that has been seen before, the existing teleport is returned with the status code of 200
func (r ApiSipTeleportServiceCreateRequest) IdempotencyKey(idempotencyKey string) ApiSipTeleportServiceCreateRequest {
	r.idempotencyKey = &idempotencyKey
	return r
}

func (r ApiSipTeleportServiceCreateRequest) Execute() (*V1SipTeleportResponse, *http.Response, error) {
	return r.ApiService.SipTeleportServiceCreateExecute(r)
}

/*
SipTeleportServiceCreate Method for SipTeleportServiceCreate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSipTeleportServiceCreateRequest
*/
func (a *SipTeleportServiceApiService) SipTeleportServiceCreate(ctx context.Context) ApiSipTeleportServiceCreateRequest {
	return ApiSipTeleportServiceCreateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SipTeleportServiceApiService) SipTeleportServiceCreateExecute(r ApiSipTeleportServiceCreateRequest) (*V1SipTeleportResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/sipteleport"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.v1CreateSipTeleport == nil {
		return localVarReturnValue, nil, reportError("v1CreateSipTeleport is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1CreateSipTeleport
...
func (r ApiSipTeleportServiceDeleteRequest) Execute() (*V1SipTeleportResponse, *http.Response, error) {
	return r.ApiService.SipTeleportServiceDeleteExecute(r)
}

/*
SipTeleportServiceDelete Method for SipTeleportServiceDelete

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSipTeleportServiceDeleteRequest
*/
func (a *SipTeleportServiceApiService) SipTeleportServiceDelete(ctx context.Context, id string) ApiSipTeleportServiceDeleteRequest {
	return ApiSipTeleportServiceDeleteRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1SipTeleportResponse
func (a *SipTeleportServiceApiService) SipTeleportServiceDeleteExecute(r ApiSipTeleportServiceDeleteRequest) (*V1SipTeleportResponse, *http.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/sipteleport/{id}"
...
func (r ApiSipTeleportServiceGetRequest) Execute() (*V1SipTeleportResponse, *http.Response, error) {
	return r.ApiService.SipTeleportServiceGetExecute(r)
}

/*
SipTeleportServiceGet Method for SipTeleportServiceGet

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSipTeleportServiceGetRequest
*/
func (a *SipTeleportServiceApiService) SipTeleportServiceGet(ctx context.Context, id string) ApiSipTeleportServiceGetRequest {
	return ApiSipTeleportServiceGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1SipTeleportResponse
func (a *SipTeleportServiceApiService) SipTeleportServiceGetExecute(r ApiSipTeleportServiceGetRequest) (*V1SipTeleportResponse, *http.Response, error) {
	var (
...
func (r ApiSipTeleportServiceListRequest) Execute() (*V1ListSipTeleportResponse, *http.Response, error) {
	return r.ApiService.SipTeleportServiceListExecute(r)
}

/*
SipTeleportServiceList Method for SipTeleportServiceList

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSipTeleportServiceListRequest
*/
func (a *SipTeleportServiceApiService) SipTeleportServiceList(ctx context.Context) ApiSipTeleportServiceListRequest {
	return ApiSipTeleportServiceListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SipTeleportServiceApiService) SipTeleportServiceListExecute(r ApiSipTeleportServiceListRequest) (*V1ListSipTeleportResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSipTeleportServiceUpdateRequest struct {
	...
	ApiService *SipTeleportServiceApiService
	id string
	v1UpdateSipTeleport *V1UpdateSipTeleport
}

// Parameters to update an existing SIPTeleport, minimum requirement of one of them defined to update
func (r ApiSipTeleportServiceUpdateRequest) V1UpdateSipTeleport(v1UpdateSipTeleport V1UpdateSipTeleport) ApiSipTeleportServiceUpdateRequest {
	r.v1UpdateSipTeleport = &v1UpdateSipTeleport
	return r
}

func (r ApiSipTeleportServiceUpdateRequest) Execute() (*V1SipTeleportResponse, *http.Response, error) {
	return r.ApiService.SipTeleportServiceUpdateExecute(r)
}

/*
SipTeleportServiceUpdate Method for SipTeleportServiceUpdate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiSipTeleportServiceUpdateRequest
*/
func (a *SipTeleportServiceApiService) SipTeleportServiceUpdate(ctx context.Context, id string) ApiSipTeleportServiceUpdateRequest {
	return ApiSipTeleportServiceUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return V1SipTeleportResponse
func (a *SipTeleportServiceApiService) SipTeleportServiceUpdateExecute(r ApiSipTeleportServiceUpdateRequest) (*V1SipTeleportResponse, *http.Response, error) {
	var (
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.v1UpdateSipTeleport == nil {
		return localVarReturnValue, nil, reportError("v1UpdateSipTeleport is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.v1UpdateSipTeleport
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
