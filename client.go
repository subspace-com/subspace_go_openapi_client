...
// APIClient manages communication with the Subspace Product API API v1.0
...
type APIClient struct {
	...
	AcceleratorServiceApi *AcceleratorServiceApiService

	GlobalTurnServiceApi *GlobalTurnServiceApiService

	ProjectServiceApi *ProjectServiceApiService

	SessionServiceApi *SessionServiceApiService

	SipTeleportServiceApi *SipTeleportServiceApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AcceleratorServiceApi = (*AcceleratorServiceApiService)(&c.common)
	c.GlobalTurnServiceApi = (*GlobalTurnServiceApiService)(&c.common)
	c.ProjectServiceApi = (*ProjectServiceApiService)(&c.common)
	c.SessionServiceApi = (*SessionServiceApiService)(&c.common)
	c.SipTeleportServiceApi = (*SipTeleportServiceApiService)(&c.common)
